          ...
          >
            ...
            <div className="flex justify-center items-center gap-4 sm:gap-6">
              <a
                ...
                className="group flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-slate-700/50 hover:bg-[#0077B5] text-white rounded-xl transition-all duration-300 hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-slate-700/50 hover:bg-[#333333] text-white rounded-xl transition-all duration-300 hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-slate-700/50 hover:bg-[#FFA116] text-white rounded-xl transition-all duration-300 hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-slate-700/50 hover:bg-[#20BEFF] text-white rounded-xl transition-all duration-300 hover:scale-110"
